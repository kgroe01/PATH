...
window.onload = function() {
  ...
  // Get the current page name (handle subdirectories like "docs/")
  var currentPage = window.location.pathname.split("/").pop().toLowerCase();

  // Adjust for GitHub Pages structure (it might serve from "docs/")
  if (currentPage === "" || currentPage === "index.html") {
    currentPage = "Login.html"; // Default page
  }
